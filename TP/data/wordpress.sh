...
show_menu(){
    ...
    echo -e "${MENU}**${NUMBER} 11)${MENU} Recherche des plugins ${NORMAL}"
    echo -e "${MENU}**${NUMBER} 12)${MENU} Installation des plugins ${NORMAL}"
    echo -e "${MENU}**${NUMBER} 13)${MENU} activation des plugins ${NORMAL}"
    echo -e "${MENU}**${NUMBER} 14)${MENU} desactiver des plugins ${NORMAL}"
    echo -e "${MENU}**${NUMBER} 15)${MENU} suppréssion des plugins ${NORMAL}"
    echo -e "${MENU}**${NUMBER} 16)${MENU} liste des plugins ${NORMAL}"
    echo -e "${MENU}*********************************************${NORMAL}"
